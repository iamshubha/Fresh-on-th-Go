                              ...
                              children: [
                                GestureDetector(
                                  onTap: () => Navigator.push(
                                      ...
                                      MaterialPageRoute(
                                          builder: (_) => ProductDetailsPage(
                                                cid: data[2]['cdata'][0]['cid'],
                                                pid: data[2]['cdata'][0]['pid'],
                                              ))),
                                  child: Container(
                                      decoration: BoxDecoration(
                                          borderRadius: BorderRadius.all(
                              ...
                              children: [
                                GestureDetector(
                                  onTap: () => Navigator.push(
                                      ...
                                      MaterialPageRoute(
                                          builder: (_) => ProductDetailsPage(
                                                cid: data[4]['cdata'][0]['cid'],
                                                pid: data[4]['cdata'][0]['pid'],
                                              ))),
                                  child: Container(
                                      decoration: BoxDecoration(
                                          borderRadius: BorderRadius.all(
